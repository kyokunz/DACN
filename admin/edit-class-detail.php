...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "update tbl_lophoc set tenlop=:cname,khoa=:khoa, ghichu=:ghichu where id=:eid";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Cập nhật thông tin lớp học </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Tổng quan</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Cập nhật thông tin lớp học</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Cập nhật thông tin lớp học</h4>

                    <form class="forms-sample" method="post">
                      <?php
                      $eid = intval($_GET['editid']);
                      $sql = "SELECT * from tbl_lophoc where id=$eid";
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="cname" value="<?php echo htmlentities($row->tenlop); ?>" class="form-control" required='true'>
                              </div>
                            </div>
                            <?php
