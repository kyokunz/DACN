...
if (isset($_POST['login'])) {
  ...
  $sql = "SELECT id FROM tbl_nguoidung WHERE username=:username and password=:password";
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  <div class="form-check">
                    <label class="form-check-label text-muted">
                      <input type="checkbox" id="remember" class="form-check-input" name="remember" <?php if (isset($_COOKIE["user_login"])) { ?> checked <?php } ?> /> Nhớ mật khẩu </label>
                  </div>
